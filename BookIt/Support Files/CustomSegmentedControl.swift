...
class CustomSegmentedControl: UIView {
    ...
    var baseLineColor: UIColor = .lightGray
...
extension CustomSegmentedControl {
    ...
    private func createButton() {
        ...
        lineView = UIView(frame: CGRect(x: 0, y: self.frame.height, width: self.frame.width, height: 3))
        lineView.backgroundColor = baseLineColor
        addSubview(lineView)
    }
}
